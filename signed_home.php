		...
		<div id="page-wrapper">
			...
			<!-- Header -->
              ...
              <li><a href="article2_signed.php?name=fasion">流行</a></li>
							...
							<li><a href="#"><?php echo $_COOKIE["name"]."已登入"; ?></a></li> <!--已登入的帳號-->
				...
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
							...
							<p>Share all your things with everyone</p>
						</header>
					</section>
					...
					<section class="box special features">
						<div class="features-row">
							<section>
								...
								<h3><a href="article2.php?name=travel">Travel</a></h3>
							...
							<section>
								...
								<h3><a href="article2.php?name=food">Food</a></h3>
						...
						<div class="features-row">
							<section>
								...
								<h3><a href="article2.php?name=life">Life</a></h3>
							...
							<section>
								...
								<h3><a href="article2.php?name=mood">Mood</a></h3>
